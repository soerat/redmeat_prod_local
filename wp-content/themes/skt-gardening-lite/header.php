...
<div class="left">
        ...
        <?php } 
		if (!empty($gplus_link)) { ?>
        <a title="<?php echo esc_attr__('google-plus','skt-gardening-lite'); ?>" class="gp" target="_blank" href="<?php echo esc_url($gplus_link); ?>"></a>
        <?php } 
  ...
  <div class="container">
    <div class="logo">
        ...
        <?php endif; ?>
         ...
         <div class="toggle"><a class="toggleMenu" href="#" style="display:none;"><?php esc_attr_e('Menu','skt-gardening-lite'); ?></a></div> 
        <div class="sitenav">
