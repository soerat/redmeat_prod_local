...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo esc_url(SKT_GARDENING_LITE_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_attr_e('Live Demo', 'skt-gardening-lite'); ?></a> | 
				<a href="<?php echo esc_url(SKT_GARDENING_LITE_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_attr_e('Buy Pro', 'skt-gardening-lite'); ?></a> | 
				<a href="<?php echo esc_url(SKT_GARDENING_LITE_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_attr_e('Documentation', 'skt-gardening-lite'); ?></a>
